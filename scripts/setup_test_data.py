...
class TestDataGenerator:
    ...
    def create_users(self):
        ...
        for data in user_data:
            ...
            user_defaults = {**data, 'tenant': tenant, 'password': make_password('password123')}
    ...
    def create_price_stages(self):
        ...
        if 'teatro-nacional_romeo_y_julieta' in self.events:
            ...
            stages = [
                {
                    ...
                    'modifier_value': Decimal('-20.00'),  # 20% descuento
                    'stage_order': 1
                },
                {
                    'name': 'Preventa',
                    ...
                    'modifier_type': PriceStage.ModifierType.PERCENTAGE,
                    'modifier_value': Decimal('0.00'),  # Precio base
                    'stage_order': 2
                },
                {
                    'name': 'Venta Regular',
                    ...
                    'modifier_type': PriceStage.ModifierType.PERCENTAGE,
                    'modifier_value': Decimal('15.00'),  # 15% aumento
                    'stage_order': 3
                }
            ]
            ...
            for stage_data in stages:
                ...
                status = "✅ Creado" if created else "⚠️  Ya existe"
                print(f"    {status}: {stage.name} ({stage.modifier_value}%)")
